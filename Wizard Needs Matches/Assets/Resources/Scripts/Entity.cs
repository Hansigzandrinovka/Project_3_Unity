...
public class Entity : MonoBehaviour { //testtest    
  public delegate void HealthChangeListener(int newHealth);    //delegates define Method Type variables, ie the "return void, take int x" type    
  ...
  {        
    ...
    //uiHealthChangeListener?.Invoke(health); 
    //if Listener defined, call it, passing in health        
    if (currentHealth <= 0)        
    {            
      Debug.Log(this + " dies");            
